                        ...
                        <ul className={`nav nav-pills flex-column`} id="parentM">
                            ...
                            <li className="nav-item text-white fs-4 my-0 py-2 py-xs-1">
                                ...
                                >
                                    ...
                                    <NavDropdown.Divider />
                                    <NavDropdown.Item as={Link} to="/Customer/PostedVacancies" className="no-hover">  End Vacancies </NavDropdown.Item>
                                    <NavDropdown.Divider />
                                ...
                                >
                                    <li className={`nav-item fs-5 ${isOpen ? "d-lg-inline" : "d-none"}`}>
                                        ...
                                        <Link to="/Customer/PostedVacancies" className="nav-link nav-link-sidebar text-white sub-item-nav ms-4"> Posted Vacancies </Link>
