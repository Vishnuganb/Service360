            ...
            <div className="sidebar-content">
              <ul className="nav nav-pills flex-column" id="parentM">
                ...
                <li className="nav-item text-white fs-4 my-0 py-2 py-xs-1">
                  <Link
                    to="/ServiceProvider/MyProjectStates"
                    className="nav-link nav-link-sidebar text-white"
                  >
                    <i
                ...
                <li className="nav-item text-white fs-4 my-0 py-2 py-xs-1">
                  <Link
                    to="/ServiceProvider/AvailabilityCalendar"
                    className="nav-link nav-link-sidebar text-white"
                  >
                    <i
                ...
                <li className="nav-item text-white fs-4 my-0 py-2 py-xs-1">
                  ...
                  >
                    <NavDropdown.Item
                      as={Link}
                      to="/ServiceProvider/ViewTrainingSessions"
                      className="no-hover"
                    >
                      {" "}
                      View Session{" "}
                    ...
                    <NavDropdown.Item
                      as={Link}
                      to="/ServiceProvider/CreateTrainingSession"
                      className="no-hover"
                    >
                      {" "}
                      Create Sessions{" "}
                    ...
                    <NavDropdown.Item
                      as={Link}
                      to="/ServiceProvider/MyTrainingSessions"
                      className="no-hover"
                    >
                      {" "}
                      My Sessions{" "}
                ...
                <li className="nav-item text-white fs-4 my-0 py-2 py-xs-1">
                  <Link
                    to="/ServiceProvider/ViewHistory"
                    className="nav-link nav-link-sidebar text-white"
                  >
