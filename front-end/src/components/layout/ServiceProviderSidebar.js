...
function ServiceProviderSideBar(){
    return(
        <div className="container-fluid ps-2 m-0">
            <div className="row">
                <div className="side-bar-sub-container col-auto col-md-2.5 min-vh-100 d-sm-inline d-flex justify-content-between flex-column">
                    <div className="sidebar-content">  
                        <ul className="nav nav-pills flex-column" id="parentM">
                            ...
                            <li className="nav-item text-white fs-4 my-0 py-2 py-sm-1">
                                ...
                                <ul className="nav collapse ms-4.5 flex-column" id="submenu-1" data-bs-parent="#parentM">
                                    <li className="nav-item fs-5 d-none d-lg-inline d-sm-none d-md-none">
                                        <a className="nav-link text-white sub-item-nav ms-4" href="#">Jobs</a>
                                    </li>
                                    <li className="nav-item fs-5 d-none d-lg-inline d-sm-none d-md-none">
                                        <a className="nav-link text-white sub-item-nav ms-4" href="#">Vacancies</a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li className="nav-item text-white fs-4 my-0 py-2 py-sm-1">
                                <a href="#submenu-2" className="nav-link sub-sec text-white fs-5" data-bs-toggle="collapse" aria-current="page">
                                ...
                                <ul className="nav collapse ms-4.5 flex-column" id="submenu-2" data-bs-parent="#parentM">
                                    <li className="nav-item fs-5 d-none d-lg-inline d-sm-none d-md-none">
                                        <a className="nav-link text-white sub-item-nav ms-4" href="#">Create a Blog</a>
                                    </li>
                                    <li className="nav-item fs-5 d-none d-lg-inline d-sm-none d-md-none">
                                        <a className="nav-link text-white sub-item-nav ms-4" href="#">My Blogs</a>
                                    </li>
