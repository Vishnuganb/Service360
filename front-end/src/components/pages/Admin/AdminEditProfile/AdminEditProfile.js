            ...
            <Modal {...props} centered>
                    ...
                    <div>
                        <Form className="my-2 mx-4">
                            ...
                            <div className="d-flex justify-content-center mb-3">
                                <img src={profileIcon} alt="Profile" style={{ width: "auto", height: "100px", borderRadius: "100%", }} />
                                <div className="d-flex justify-content-end align-items-end align-self-end">
                                    ...
                                    <label htmlFor="fileInput">
                                        <i className="bi bi-plus-circle-fill fs-5" onClick={handleFileInputClick} style={{ cursor: "pointer" }}></i>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div className="justify-content-between mb-3 d-flex">
                                <div className='me-0 col-sm-6'>
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => (data.isEditMode ? setdata({ ...data, firstName: e.target.value }) : null)}
                                ...
                                <div className='col-sm-5'>
                                    ...
                                    <input
                                        ...
                                        value={data.lastName}
                                        onChange={(e) => (data.isEditMode ? setdata({ ...data, lastName: e.target.value }) : null)}
                                        readOnly={!data.isEditMode}
                                        required
                                    />
                            ...
                            <div className="justify-content-between mb-3 d-flex">
                                ...
                                <div className='col-sm-5'>
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => (data.isEditMode ? setdata({ ...data, contactNumber: e.target.value }) : null)}
                                        readOnly={!data.isEditMode}
                                        required
                                    />
                            ...
                            <div className="mb-3">
                                ...
                                <div className="align-items-center">
                                    <input
                                        ...
                                        value={data.address}
                                        onChange={(e) => (data.isEditMode ? setdata({ ...data, address: e.target.value }) : null)}
                                        readOnly={!data.isEditMode}
                                        required
                                    />
                ...
                <Modal.Footer>
                    <div className="col-sm-6 d-flex justify-content-end align-items-end m-0">
                        <Button className="btn-effect me-2" type="button" onClick={data.isEditMode ? handleSave : toggleEditMode}>
