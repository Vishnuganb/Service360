...
function AdminCustomer() {
        ...
        const fetchData = async () => {
            try {
                ...
                setData(({
                    ...
                    displayedServices: detail.slice(0, cardsPerPage),
                }));
            } catch (error) {
    ...
    useEffect(() => {
        const searchedServices = data.searchTerm.trim() === '' ? data.customersData : data.customersData.filter((customer) => (
                        ...
                        <div className="row">
                            <div className="col-sm-6 d-flex justify-content-start align-items-center">
                                <Form.Check
                                    ...
                                    onChange={() => setData({ ...data, enabled: false })}
                                ...
                                <Form.Check
                                    ...
                                    label="Disable"
                                    checked={!data.enabled}
                                    onChange={() => setData({ ...data, enabled: true })}
                                    className='ms-0 me-1 custom-radio'
                                />
                            </div>
