...
const ServiceProviderEditProfile = (props) => {
        ...
        try {
            ...
            if (response.data) {
                ...
                setdata({
                    ...
                    nicNumber: response.data.nic,
                    imageSrc: response.data.profilePic ? response.data.profilePic : profileIcon,
                });
            }
        } catch (error) {
    ...
    const handleImageChange = (e) => {
        if (e.target.files && e.target.files[0]) {
            ...
            setdata({ ...data, imageSrc: profileIcon });
        }
    };
    ...
    const handleSave = async () => {
        ...
        } else if (!/^(\d{9}[vV]|\d{12})$/.test(data.nicNumber)) {
            isError = true;
            console.log("image changed7");
            setdata({ ...data, nicNumberErrorMessage: "Invalid nic number" });
        ...
        if (!isError) {
            ...
            if (data.nicNumber !== userDetail.nic) {
                formData.append("nic", data.nicNumber);
            }
    ...
    return (
        <Container>
            <Modal {...props} centered>
                ...
                <Modal.Body className="d-flex" style={{ backgroundImage: `url(${BgImage})` }}>
                    <div>
                        <Form className="my-2 mx-4">

                            <div className="d-flex justify-content-center mb-3">
                                {data.imageSrc === "null" && setdata({ ...data, imageSrc: profileIcon })}
                                {data.imageSrc && <img src={data.imageSrc} alt="Profile" style={{ width: "100px", height: "100px", borderRadius: "100%", }} />}
                                <div className="d-flex justify-content-end align-items-end align-self-end">
                                    ...
                                    <label htmlFor="fileInput">
                                        <i className="bi bi-plus-circle-fill fs-5" style={{ cursor: "pointer" }}></i>
                                    </label>
                                </div>
                            </div>
                            ...
                            <div className="justify-content-between mb-3 d-flex">
                                <div className='me-0 col-sm-6'>
                                    <p className="mb-0 align-self-start">Residential Address</p>
                                    <input
                                        type="text"
                                        className="form-control"
                                        value={data.address}
                                ...
                                <div className='col-sm-5'>
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => {
                                            setdata({ ...data, nicNumber: e.target.value });
                                        }}
                                        required
                                    />
