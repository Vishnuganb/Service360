      ...
      <div className="single-job-card">
        ...
        <div className="job-card-body">
          <div className="job-card-body-left">
            <span className="single-job-status" id="job-status">
              New
            </span>
            <br />
            <span className="single-job-title">Painting</span>
            <br />
            <span className="sinlge-job-sub-info">Urgent | Electrician</span>
            <br />
            <span className="single-job-description">
              Need to fix inverter need to wiring
            </span>
            <br />
