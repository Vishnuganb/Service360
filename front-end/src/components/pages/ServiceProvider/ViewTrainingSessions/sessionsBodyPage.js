                ...
                <div className="single-my-training-card mx-auto mt-3">
                    <div className="row">
                        <div className="col-md-5 col-12 my-training-card-body-left d-flex justify-content-center justify-content-md-start">
                            <img className="view-training-image" src={TrainingSession.sessionImage} alt="Power" />
                        </div>
                        <div className="col-md-7 col-12 my-training-card-body-right">
                            <span className="single-my-training-info">{TrainingSession.sessionTitle}</span>
                            <br />
                            <span className="my-training-location-info">
                                <i className="bi bi-geo-alt-fill"></i>&nbsp; Location: {TrainingSession.location}
                            </span>
                            <br />
                            <span className="single-my-training-time">
                                <i className="bi bi-clock-fill"></i>&nbsp; Saturday, {TrainingSession.date} At {TrainingSession.time}
                            </span>
                            <br/>
                            <div className="single-traning-guests border border-dark mt-2 mb-4 col">
                                ...
                                <div className="custom-training-row row">
                                    <span className="single-my-training-intrested border border-primary col-6">{TrainingSession.intrested} intrested</span>
