...
import {Container,Form,Table,Row,Col,Dropdown, Button,InputGroup } from "react-bootstrap";
            ...
            {/* <Col>
              <Dropdown>
                <Dropdown.Toggle variant="primary" id="dropdown-basic">
                  Select a Sevice Category
                </Dropdown.Toggle>

                <Dropdown.Menu>
                  <Dropdown.Item>Interior Work</Dropdown.Item>
                  <Dropdown.Item>Electric and Plumbing</Dropdown.Item>
                  <Dropdown.Item>Construction</Dropdown.Item>
